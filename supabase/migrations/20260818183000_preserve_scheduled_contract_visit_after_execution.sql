...
-- O card roxo era apenas uma apresentação duplicada da execução. A proteção
-- continua valendo para o slot programado, mas permite remover essa versão
-- legada durante o reabastecimento.
