...
import AnalisesOperacionaisPage from "./pages/financeiro/AnalisesOperacionaisPage.tsx";
          ...
          <ProtectedRoute>
            <AppLayout>
              <Routes>
                ...
                <Route path="/financeiro/analises-operacionais" element={<AnalisesOperacionaisPage />} />
